...
export const ARTIFACT_MAIN_STATS_VALUES = {
...
export const ARTIFACT_SUB_STATS = ['HP', 'ATK', 'DEF', 'HP%', 'ATK%', 'DEF%', 'EnergyRecharge', 'ElementalMastery', 'CriticalRate', 'CriticalDamage'];
